...
<div class="w3-sidebar w3-bar-block w3-black w3-xxlarge" style="width:50px;font-size:25px!important;">
  ...
  <a href="TaskManager1.php" class="w3-bar-item w3-button" style="background-color:#F1F1F1;color:black;"><i class="fa fa-tasks"></i></a><br>
...
?> </i><b class="caret"></b></a>
   ...
   <h2 align="center"> <img src="taskicon.png" width=7%>&nbsp;To Do List</h2>
    ...
    <form method="post" action="TaskManager.php" >
      ...
      <div class="notcomp" style="margin-top:5%;margin-bottom:20%">
       <center><h4 ><i class='fa fa-pencil-square-o'>&nbsp;   </i>Not Completed Tasks</h4></center>
    <br>
  <?php
...
$conn = mysqli_connect($servername, $username, $password, $database);
    $sql = "update tasks set status='c' where tid='".$_GET['hello']."'";
     ...
     echo '<meta http-equiv=Refresh content="0;url=TaskManager1.php?reload=1">';
}
	}
  }
