...
<div class="w3-sidebar w3-bar-block w3-black w3-xxlarge" style="width:50px;font-size:25px!important;">
  ...
  <a href="chat.php" class="w3-bar-item w3-button" style="background-color:#F1F1F1;color:black;"><i class="fa fa-paper-plane-o"></i></a> <br>
...
$(document).ready(function(){
 ...
 function make_chat_dialog_box(to_user_id, to_user_name)
 {
  ...
  modal_content += '<div style="height:300px; border:1px solid #ccc; overflow-y: scroll;margin-top:0px; margin-bottom:0px; padding:0px;" class="chat_history" data-touserid="'+to_user_id+'" id="chat_history_'+to_user_id+'">';
  modal_content += 'Loading ...';
  modal_content += '</div>';
  modal_content += '<div class="form-group"><form action="chat.php" method="post" enctype="multipart/form-data">';
